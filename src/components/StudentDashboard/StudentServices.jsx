    ...
    <div className="container mx-auto py-8">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid w-full grid-cols-2 lg:grid-cols-5">
          ...
          <TabsTrigger value="course-registration">
            Course Registration
          </TabsTrigger>
          ...
          <TabsContent value="email">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Send an email to the institute administration
                </CardDescription>
              </CardHeader>
              <CardContent>
                <EmailForm />
          ...
          <TabsContent value="course-registration">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Register for new courses or view your current schedule
                </CardDescription>
              </CardHeader>
              <CardContent>
                <CourseRegistration />
          ...
          <TabsContent value="studygroup">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  find your partner for Group Study
                </CardDescription>
              </CardHeader>
              <CardContent>
                <StudyGroupFinder />
